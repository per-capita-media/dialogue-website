...
<a href="/supervisor" class="meta-text underline">← All students</a>
...
<div class="grid md:grid-cols-3 gap-4 mt-6">
	<a href={`/supervisor/students/${data.student.id}/pitches`} class="card hover:border-accent-blue transition-colors">
		<h3 class="heading-2">Pitches</h3>
		<p class="body-text mt-1">{data.pitches.length}/5 slots filled</p>
	</a>
	<a href={`/supervisor/students/${data.student.id}/articles/1`} class="card hover:border-accent-blue transition-colors">
		<h3 class="heading-2">Article 1</h3>
		<p class="body-text mt-1">{data.articles.find((a) => a.article_number === 1)?.status ?? 'not yet started'}</p>
	</a>
	<a href={`/supervisor/students/${data.student.id}/articles/2`} class="card hover:border-accent-blue transition-colors">
