...
<h1 class="heading-1">Reading material</h1>
{#if data.material}
	<div class="card mt-4">
	...
	<div class="mt-6">
		<a class="btn-primary" href="/student/learning/document-quiz">Take the quiz →</a>
	</div>
{:else}
	<div class="alert-error mt-6">No active reading material yet. Check back soon.</div>
{/if}
