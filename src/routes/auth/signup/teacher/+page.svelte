<script lang="ts">
	...
	const REASONS: Record<string, string> = {
		'no-token': 'This page is for teachers invited by an admin. Ask your admin for a signup link.',
		'unknown-token': 'That invitation link is not recognised.',
		'wrong-role': 'That invitation is not a teacher invitation.',
...
<section class="container max-w-md py-16">
	...
	<h1 class="heading-1 mt-2">Teacher signup</h1>
	...
	{#if !data.usable}
		...
		<p class="body-text mt-4 text-sm">
			Teacher accounts are issued by invitation only. Teachers see their own school/contact
			cohort summary, not student submissions or private editor feedback.
		</p>
	{:else}
		<p class="body-text mt-2">Welcome — finish setting up your teacher account.</p>
