...
<a href="/admin/learning-materials" class="meta-text underline">← All materials</a>
<h1 class="heading-1 mt-2">Edit material</h1>

<form method="POST" enctype="multipart/form-data" class="card mt-6 space-y-4">
